...
public class MascotaServiceTest {
	...
	void registrarMascotaDebeGuardarYRetornarDto() {
		...
		when(mascotaRepository.save(org.mockito.ArgumentMatchers.any(Mascota.class))).thenReturn(guardada);
		...
		verify(mascotaRepository).save(org.mockito.ArgumentMatchers.any(Mascota.class));
	}
